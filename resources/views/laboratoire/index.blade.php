            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Liste des laboratoires</h5>
                        <div class="ibox-tools">
                           <a href="{{ url('laboratoires/create') }}"  class="btn btn-primary" role="button" > Ajouter</a>
                    ...
                    <tbody>
                    @foreach($aboratoirelist as $item)    
                    <tr class="gradeX">
                        <td>{{ $item->nom }}</td>
                        <td>{{ $item->email }}</td>
                        <td>{{ $item->tel }}</td>
                        ...
                        <td class="center" style="padding-left:10px;"> 
                            <a  href="{{ url('laboratoires/'.$item->id.'/edit') }}" class="btn btn-warning btn-xs">Modifier</a> 
...
<script>
    $(document).ready(function(){
        ...
        $('.delete').click((e) => {
            ...
            console.log(id)
            $(".modal-footer form").attr("action", "laboratoires/"+id);
        });
